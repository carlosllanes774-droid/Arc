...
function loadFrontendWeekSandbox() {
  ...
  const chunks = [
    sliceIndexLines(3621, 3649),
    sliceIndexLines(3661, 3679),
    sliceIndexLines(4280, 4357),
    sliceIndexLines(8130, 8135),
    sliceIndexLines(8152, 8177),
    sliceIndexLines(8227, 8259)
  ];
